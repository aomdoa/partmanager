...
import ca.aomdoa.partmanager.domain.Footprint;

@RepositoryRestResource(collectionResourceRel = "footprints", path = "footprint")
public interface FootprintRepository extends PagingAndSortingRepository<Footprint, Long> {
	public Footprint findByName(@Param("name") String name);
}
