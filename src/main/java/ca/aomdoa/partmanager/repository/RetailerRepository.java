...
import ca.aomdoa.partmanager.domain.Retailer;

@RepositoryRestResource(collectionResourceRel = "retailers", path = "retailer")
public interface RetailerRepository extends PagingAndSortingRepository<Retailer, Long> {
    public Retailer findByName(@Param("name") String name);
}
